...
LANG_WARN_EMOJI="⚠️"
LANG_ERROR_EMOJI="❌"
LANG_LOG_OK_PREFIX="[สำเร็จ]"
LANG_LOG_WARN_PREFIX="[คำเตือน]"
LANG_LOG_ERROR_PREFIX="[ข้อผิดพลาด]"

# ข้อความทั่วไป
LANG_ALREADY_DONE="เสร็จแล้ว ข้ามขั้นตอน"
LANG_STEP_DONE="เสร็จสิ้น."
LANG_PAUSE_PROMPT="กด Enter เพื่อดำเนินการต่อ…"

# เมนู
LANG_MENU_STATUS="สถานะติดตั้ง & ถอนการติดตั้ง"
LANG_MENU_EXTENSION="ติดตั้ง & ลบส่วนขยาย"
LANG_BATCH_DONE="ชุดเสร็จสิ้น"
